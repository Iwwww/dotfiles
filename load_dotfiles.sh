...
cp -rv "$HOME/.config/fnott" ".config/"
...
cp -rv "$HOME/.config/river" ".config/"
cp -rv "$HOME/.config/foot" ".config/"
cp -rv "$HOME/.config/systemd" ".config/"
cp -rv "$HOME/.config/wlogout" ".config/"
cp -rv "$HOME/.config/yazi" ".config/"
cp -rv "$HOME/.config/zathura" ".config/"
